...
mod tests {
    ...
    fn test_context_assoc_single_insert() {
        ...
        assert_eq!(
            error.to_string(),
            "sqlite failure: 'UNIQUE constraint failed: context_assoc.context_id, context_assoc.sample_id'"
        );
    }
    ...
    fn test_coverage_sample_single_insert() {
        ...
        assert_eq!(
            error.to_string(),
            "sqlite failure: 'UNIQUE constraint failed: coverage_sample.id'"
        );
    }
    ...
    fn test_branches_data_single_insert() {
        ...
        assert_eq!(
            error.to_string(),
            "sqlite failure: 'UNIQUE constraint failed: branches_data.id'"
        );
    }
    ...
    fn test_method_data_single_insert() {
        ...
        assert_eq!(
            error.to_string(),
            "sqlite failure: 'UNIQUE constraint failed: method_data.id'"
        );
    }
    ...
    fn test_span_data_single_insert() {
        ...
        assert_eq!(
            error.to_string(),
            "sqlite failure: 'UNIQUE constraint failed: span_data.id'"
        );
    }
}
